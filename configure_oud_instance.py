...
oud_createInstance(scriptName='oud-setup', instanceName='oud1', hostname='fmw.lab.co.nz', ldapPort=3389, rootUserDN='cn=Directory\ Manager',rootUserPasswordFile='oud_password.txt',baseDN='dc=lab,dc=co,dc=nz', sampleData=5, adminConnectorPort=6444)
